package com.peter_burbery.journal_004;
...
//	            table.getColumnModel().getColumn(2).setPreferredWidth(60);  // Edit Button
//	            table.getColumnModel().getColumn(3).setPreferredWidth(180); // Date Created
//	            table.getColumnModel().getColumn(4).setPreferredWidth(180); // Date Updated
...
//
//		String query = "SELECT JOURNAL_002, JOURNAL_002_ID, date_created, date_updated FROM JOURNAL_002";
//
//		// Apply sorting logic if sorting is enabled
//		if (sortingOptionsDialog != null && sortingOptionsDialog.isSortingEnabled()) {
//			query += " ORDER BY " + sortingOptionsDialog.getSortColumn()
...
//			while (rs.next()) {
//				model.addRow(new Object[] { rs.getString("JOURNAL_002"), // Journal Entry
