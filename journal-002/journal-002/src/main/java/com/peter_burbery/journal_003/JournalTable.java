package com.peter_burbery.journal_003;
...
public class JournalTable {
    ...
    SwingUtilities.invokeLater(() -> {
        if (initializeDatabaseConnection()) {
         ...
         // Set cell renderers and editors for the "Edit" column
            ...
            scrollPane.addComponentListener(new java.awt.event.ComponentAdapter() {
                ...
                public void componentResized(java.awt.event.ComponentEvent e) {
                    ...
                    if (availableWidth > 100) {
                        ...
                        table.getColumnModel().getColumn(0).setPreferredWidth(100); // Minimum width for "Journal Entry"
                    }
            ...
            addButton.addActionListener(e -> {
                ...
                if (newEntryId != null) {
                    model.addRow(new Object[]{newEntry, newEntryId, "Edit"});
                }
            });
	    ...
	    try (Statement stmt = connection.createStatement(); ResultSet rs = stmt.executeQuery(query)) {
	        while (rs.next()) {
	            model.addRow(new Object[]{
	                rs.getString("JOURNAL_002"),
	                rs.getString("JOURNAL_002_ID"),
	                "Edit"
	            });
	        }
	    } catch (SQLException e) {
